...
desenvolvedores = read_csv(here::here("data/Teamwork Quality (respostas) - Respostas ao formulário 1.csv"))
...
model <- '  #model
            teamWork =~ communication_mean +
                        ...
                        cohesion_mean + 
                        contribution_mean
            performance =~ effectiveness_mean + efficiency_mean
            #regressão
            performance ~ teamWork
'
                         

fit <- sem(model, data = means)
